    ...
    <>
      ...
      >
        <div className="hv-preserve-dark relative rounded-[32px] border border-white/5 bg-[#081120]/72 p-2.5 shadow-[0_18px_60px_rgba(2,6,23,0.36),0_0_34px_rgba(34,211,238,0.09)] backdrop-blur-2xl">
          ...
          <motion.nav
            className="relative flex max-w-[calc(100vw-2rem)] items-center gap-1.5 overflow-x-auto md:w-[46px] md:max-w-none md:flex-col md:gap-1.5 md:overflow-visible md:py-1 xl:w-12"
            initial="hidden"
            animate="visible"
