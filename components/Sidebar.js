...
export default function Sidebar({ initialProfile = null, overview = null }) {
  ...
  useEffect(() => {
    if (overview) {
      queueMicrotask(() => setWorkflowOverview(overview))
    }
  }, [overview])
  ...
  return (
    <>
      <aside className="mt-10 rounded-2xl border border-slate-800 bg-slate-900/80 p-5 shadow-[0_14px_44px_rgba(2,6,23,0.18)] xl:p-3.5 2xl:p-4">
