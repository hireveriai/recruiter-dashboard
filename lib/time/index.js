...
export function getOrgTimezone(orgTimezone) {
  if (!orgTimezone && typeof window !== "undefined" && window.__VERISNOVA_ORG_TIMEZONE__) {
    return window.__VERISNOVA_ORG_TIMEZONE__
  }
...
export function getOrgTimezoneLabel(orgTimezone, timezoneLabel) {
  if (!timezoneLabel && typeof window !== "undefined" && window.__VERISNOVA_ORG_TIMEZONE_LABEL__) {
    return window.__VERISNOVA_ORG_TIMEZONE_LABEL__
  }
